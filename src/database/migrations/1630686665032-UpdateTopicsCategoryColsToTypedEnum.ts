...
export class UpdateTopicsCategoryColsToTypedEnum1630686665032 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "event" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "description" text NOT NULL, "category" text NOT NULL, "event_link" text NOT NULL, "ticket_link" text NOT NULL, "cost" integer NOT NULL, "category_text" text NOT NULL, "when" date NOT NULL, "location" text NOT NULL, "who" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "panelists" text, "audience" text, "agenda" text, "topics" text NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`
    );
